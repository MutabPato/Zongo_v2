...
- The three-role matrix runner is available at `infra/admin-panel/verify-role-matrix.sh`; execution remains pending named synthetic Support, Ops, and Admin credentials.
