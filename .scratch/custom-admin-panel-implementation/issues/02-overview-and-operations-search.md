...
- [ ] Role-aware overview metrics and queues are rendered through explicit `/admin/v1` workflow read models.
- [ ] Operations search supports approved query, status, pagination, filtering, and safe empty/loading/error states.
- [ ] Results use the standard list envelope and preserve exact money values as strings.
- [ ] Role visibility and server authorization are tested for Support, Ops, and Admin.
